...
def risk(dsvm, X, y):
    ...
    tests = {
            "$C = 2^{-3}\;\;\mathrm{e}\;\;c = 3$"   : {'C': 2**-3, 'c': 3}
            # "$C = 2^{-5}\;\;\mathrm{e}\;\;c = 0.5$"   : {'C': 2**-5, 'c': 0.5},
            # "$C = 2^{-5}\;\;\mathrm{e}\;\;c = 1$"  : {'C': 2**-5, 'c': 1},
            # "$C = 2^{-5}\;\;\mathrm{e}\;\;c = 3$"  : {'C': 2**-5, 'c': 3},
            # "$C = 2^{-2}\;\;\mathrm{e}\;\;c = 0.5$"    : {'C': 2**-2, 'c': 0.5},
            # "$C = 2^{-2}\;\;\mathrm{e}\;\;c = 1$"   : {'C': 2**-2, 'c': 1},
            # "$C = 2^{-2}\;\;\mathrm{e}\;\;c = 3$"   : {'C': 2**-2, 'c': 3},
            # "$C = 2\;\;\mathrm{e}\;\;c = 0.5$"         : {'C': 2, 'c': 0.5},
            # "$C = 2\;\;\mathrm{e}\;\;c = 1$"        : {'C': 2, 'c': 1},
            # "$C = 2\;\;\mathrm{e}\;\;c = 3$"        : {'C': 2, 'c': 3},
            # "$C = 2^{3}\;\;\mathrm{e}\;\;c = 0.5$"     : {'C': 2**3, 'c': 0.5},
            # "$C = 2^{3}\;\;\mathrm{e}\;\;c = 1$"    : {'C': 2**3, 'c': 1},
            # "$C = 2^{3}\;\;\mathrm{e}\;\;c = 3$"    : {'C': 2**3, 'c': 3}
            }
    ...
    risk_dist    = {
            "$C = 2^{-3}\;\;\mathrm{e}\;\;c = 3$" : []
            # "$C = 2^{-5}\;\;\mathrm{e}\;\;c = 0.5$" : [],
            # "$C = 2^{-5}\;\;\mathrm{e}\;\;c = 1$"   : [],
            # "$C = 2^{-5}\;\;\mathrm{e}\;\;c = 3$"   : [],
            # "$C = 2^{-2}\;\;\mathrm{e}\;\;c = 0.5$" : [],
            # "$C = 2^{-2}\;\;\mathrm{e}\;\;c = 1$"   : [],
            # "$C = 2^{-2}\;\;\mathrm{e}\;\;c = 3$"   : [],
            # "$C = 2\;\;\mathrm{e}\;\;c = 0.5$"      : [],
            # "$C = 2\;\;\mathrm{e}\;\;c = 1$"        : [],
            # "$C = 2\;\;\mathrm{e}\;\;c = 3$"        : [],
            # "$C = 2^{3}\;\;\mathrm{e}\;\;c = 0.5$"  : [],
            # "$C = 2^{3}\;\;\mathrm{e}\;\;c = 1$"    : [],
            # "$C = 2^{3}\;\;\mathrm{e}\;\;c = 3$"    : []
            }
    ...
    for train_index, test_index in skf.split(X, y):
        ...
        dsvm.network.split_data(X_train, y_train)
        ...
        for test, params in tests.items():
            ...
            dsvm.fit(X_train_scale, y_train)
            risks = dsvm.all_iters_risk(X_test_scale, y_test)
